...
public class Application {
    ...
    // private long endTime; @Autowired
    @Autowired
    ...
    public void init(LoginRepository loginRepository, RolesRepository rolesRepository,
        ...
        try {
            Scanner names = new Scanner(new File(
                    "SpringApi\\racetiming\\src\\main\\java\\com\\racetiming\\racetiming\\files\\Names.txt"));
            Scanner splitnames;
            Scanner cities = new Scanner(new File(
                    "SpringApi\\racetiming\\src\\main\\java\\com\\racetiming\\racetiming\\files\\Cities.txt"));
            Scanner disciplines = new Scanner(new File(
                    "SpringApi\\racetiming\\src\\main\\java\\com\\racetiming\\racetiming\\files\\Disciplines.txt"));
            Scanner descriptions = new Scanner(new File(
                    "SpringApi\\racetiming\\src\\main\\java\\com\\racetiming\\racetiming\\files\\Descriptions.txt"));
            Scanner urls = new Scanner(new File(
                    "SpringApi\\racetiming\\src\\main\\java\\com\\racetiming\\racetiming\\files\\Url.txt"));
            Scanner categories = new Scanner(new File(
                    "SpringApi\\racetiming\\src\\main\\java\\com\\racetiming\\racetiming\\files\\Categories.txt"));
            Scanner playerNames = new Scanner(new File(
                    "SpringApi\\racetiming\\src\\main\\java\\com\\racetiming\\racetiming\\files\\PlayerNames.txt"));
            Scanner countries = new Scanner(new File(
                    "SpringApi\\racetiming\\src\\main\\java\\com\\racetiming\\racetiming\\files\\Countries.txt"));
            Scanner phoneNumbers = new Scanner(new File(
                    "SpringApi\\racetiming\\src\\main\\java\\com\\racetiming\\racetiming\\files\\PhoneNumbers.txt"));
            Scanner teams = new Scanner(new File(
                    "SpringApi\\racetiming\\src\\main\\java\\com\\racetiming\\racetiming\\files\\Teams.txt"));
            Scanner licenses = new Scanner(new File(
                    "SpringApi\\racetiming\\src\\main\\java\\com\\racetiming\\racetiming\\files\\Licenses.txt"));
            ...
            while (categories.hasNext()) {
                categoriesList.add(new Category(categories.nextLine()));
            }
            ...
            while (names.hasNext()) {
                ...
                competitions.add(new Competition(splitnames.next() + " Competitions", citiesList.get(cityIndex),
                        ...
                        urls.nextLine(), new Random().nextInt(1000) / 10 * 10, urls.nextLine(), playersInCompetition,
                        categoriesList));
                splitnames.close();
            }
            // ------------------------PlayerCategory
            ...
            for (Competition comp : competitions) {
                for (Player player1 : comp.getPlayers()) {
                    playerCategoryList.add(new PlayerCategory(player1, comp,
                            categoriesList.get(new Random().nextInt(categoriesList.size() - 1))));
                }
            }
